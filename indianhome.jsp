<%-- 
    Document   : indianhome
    Created on : Jan 11, 2022, 2:11:19 PM
    Author     : JAVA
--%>
    ...
    <h1 style="margin-top:10px;margin-left: 5px">Multi Banking</h1>
            <nav>
                <ul class="main-nav" style="height: 20px;">                  
                    ...
                    <li><a href="itransaction.jsp?accountno=<%=iacc%>">Transaction History</a></li>
                    <li><a href="indian.jsp"> Logout</a></li>
        ...
        <div class="container"  style="        height: 632px;
    margin-top: -12px;
    margin-left: 321px;">
        ...
        <div class="container-body" style="background-image: linear-gradient(90deg, rgb(2 0 36 / 38%) 0%, rgb(12 12 29 / 0%) 38%, rgb(0 212 255 / 55%) 100%) ;margin-top: -12px;">
                <div class="profile-picture" > 
                    <img src="img/indian logo.png" style="height: 280px;     margin-top: -155px;">
            </div>
            <div class="name">
            ...
            <div class="stats" style="margin-top:5px">
                <div class="followers" style="    margin-top: 23px;    margin-left: -10px;">
                    <p>Acc.Number</p>
                ...
                <div class="buttons" style="        margin-top: -65px;
    margin-left: -35px;">
                    <button class="message-me"><a href="transfer.jsp?accountno=<%=rs1.getString("accountno")%>">Money Transfer
                        </a> </button>
