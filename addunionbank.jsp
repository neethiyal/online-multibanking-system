<%-- 
    Document   : addunionbank
    Created on : Jan 11, 2022, 9:46:15 AM
    Author     : JAVA
--%>
...
--> 
        ...
        <form action="unionbankcheck.jsp" method="post" style="margin-top: -30px; height: 590px;">
            ...
            <input type="hidden" value="union" style="background: white;">
