<%-- 
    Document   : addindianbank
    Created on : Jan 8, 2022, 1:19:39 PM
    Author     : JAVA
--%>
        ...
        <a href="indian.jsp">
            <image id="testImg" 
               src="img/indian logo.png"
                ...
                y="140"  
                height="40" 
                style="height: 180px; margin-left: 70px; margin-top: 20px;"></image>
        </a>
...
--> 
        ...
        <form action="indianbankcheck.jsp" method="post" style="margin-top: -40px; height: 590px;">
            ...
            <input type="hidden" value="indian" style="background: white;">
