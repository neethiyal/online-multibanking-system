<%-- 
    Document   : utransaction
    Created on : Jan 18, 2022, 10:41:37 AM
    Author     : JAVA
--%>
...
<html>
    <head>
        ...
        <title>UNION BANK TRANSACTION HISTORY</title>
        ...
        <h1 style="margin-top:10px">Online MultiBanking</h1>
            <nav>
                <ul class="main-nav" style="height: 20px;">                  
                    <li><a href="unionhome.jsp"> Home</a></li>

                    <li><a href="union.jsp"> Logout</a></li>
      </ul>
</nav>
...
">
		...
		<td align="center"><%=rs1.getString("name")%></td>
                <td align="center" style="color: green;"><%=rs1.getString("cash")%></td>
		<td align="center"><%=rs1.getString("time")%></td>
